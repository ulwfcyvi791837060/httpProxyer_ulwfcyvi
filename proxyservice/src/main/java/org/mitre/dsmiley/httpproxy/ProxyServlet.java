...
import com.gwb.proxyservice.servlet.LoginDto;
...
public class ProxyServlet extends HttpServlet {
  ...
  protected void copyRequestHeaders(HttpServletRequest servletRequest, HttpRequest proxyRequest) {
    ...
    String token = login();
    Header authorization = proxyRequest.getFirstHeader("authorization");
  ...
  private String login() {
    ...
    try {
      ...
      /*//创建redis核心对象
      ShardedJedis jedis = ProxyConfigUtility.pool.getResource();
      String appLogin = jedis.get("appLogin");
      //取值并打印
